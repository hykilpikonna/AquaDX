...
INSERT INTO `property` (property_key, property_value) VALUE ('ongeki_music_ng_list', '');
INSERT INTO `property` (property_key, property_value) VALUE ('ongeki_music_recommend_list', '');